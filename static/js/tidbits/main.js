function flipCoin () {
    ...
    '<a class="subtitle has-text-centered" onclick="flipCoin()">Flip a coin</a>' }, 5000);
}
...
function checkBirthday() {
    ...
    if (d.getDate() === 16 && d.getMonth() === 3) {
        ...
        '<a class="subtitle has-text-centered" onclick="checkBirthday()">Is it Sean\'s birthday?</a>' }, 5000);
    }
    else {
        document.getElementById("birthday").innerHTML =
